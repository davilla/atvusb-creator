...
if [ -e $DISKIMAGE ]; then
  ...
  echo $PW | sudo -S installer -pkg /Volumes/boxee-0.9.3935/boxee-0.9.3935.mpkg -target /
  echo $PW | sudo -S hdiutil detach /Volumes/boxee-0.9.3935
  ...
  # clean up
  #if [ -e /Users/Frontrow/Movies/boxee-0.9.3935 ]; then
  # something makes this symlink during install so zap it.
  echo $PW | sudo -S rm /Users/Frontrow/Movies/boxee-0.9.3935
  #fi
